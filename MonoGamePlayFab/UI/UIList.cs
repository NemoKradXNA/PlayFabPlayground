...
namespace MonoGamePlayFab.UI
{
    public class UIList<T> : UIBase
    {
        ...
        public List<IUIListItem<T>> ItemList { get; set; }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int e = ItemList.Count - 1; e >= 0; e--)
            {
                IUIListItem<T> thisEvt = ItemList[e];
                _spriteBatch.DrawString(ListFont, thisEvt.Text, rootPosition, thisEvt.TextColor);
