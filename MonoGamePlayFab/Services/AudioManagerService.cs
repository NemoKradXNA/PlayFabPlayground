...
{
    public class AudioManagerService : GameComponent, IAudioManager
    {
        ...
        public AudioManagerService(Game game, float masterVolume = 1, float musicVolume = 1, float sfxVolume = 1) : base(game)
        {
